function scriptHomePerfil(conteudo) {
    conteudo.innerHTML = `
        ...
        <div class="perfil-forms">
            <form id="form-nome">
                ...
                <input type="text" id="nome" name="nome" placeholder="Informe novo nome de exibição" required>
            ...
            <form id="form-email">
                ...
                <input type="email" id="email" name="email" placeholder="Informe o novo email" required>
                <button  type="submit">Salvar</button>
            </form>
            ...
            <form id="form-senha">
                ...
                <input type="password" id="confirma-senha" name="confirma-senha" placeholder="Confirmar nova senha" required>
                <button  type="submit">Salvar</button>
            </form>
        </div>
        ...
        <div class="tema">
        <span class="legenda-tema">TROCAR TEMA</span>
                <label class="theme-switch">
                        <input type="checkbox" class="theme-switch__checkbox" id="switch">
    ...
    // Adiciona os manipuladores de evento para cada formulário
...
// Função fictícia para obter o token CSRF
